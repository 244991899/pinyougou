...
<!--页面顶部 开始-->
<#include "head.ftl">
<#assign imageList=goodsDesc.itemImages?eval /> <#--转换成对象-->
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" ng-model="num" type="text" value="{{num}}" minnum="1" class="itxt" />
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#" target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addToCar()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
							...
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributeList as item>
										<#if item.value??> <#--如果item.value存在才显示-->
